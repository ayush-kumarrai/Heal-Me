...
const API_KEY = '';//US EYOUR OWN API KEY
...
const PredictionForm = () => {
  ...
  type="submit"
  onClick={handleClick}
  className="relative overflow-visible rounded-full hover:-translate-y-1 px-12 shadow-xl bg-[#3498db]
    after:content-[''] after:absolute after:rounded-full after:inset-0 after:bg-[#2980b9]
    after:z-[-1] after:transition after:duration-500 hover:after:scale-150 hover:after:opacity-0 text-white"
>
