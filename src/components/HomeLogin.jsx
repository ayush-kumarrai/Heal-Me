    ...
    <div className="overflow-x-hidden">
      ...
      <section className="hero bg-cover bg-center min-h-screen relative text-white py-8 sm:py-20 flex items-center" 
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <motion.h2
            className="mt-6 sm:mt-8 px-4 text-white text-2xl sm:text-3xl lg:text-4xl"
      ...
      {[
        {
          ...
          route: '/imageDiagnosis',
          imageFirst: false
        },
        {
          title: "ML Lungs Cancer Predictor",
          description: "Our ML Disease Predictor uses advanced algorithms to analyze Lung Cancer data and predict potential health risks. By simply uploading your MRI, you can get proactive health alerts and preventive suggestions, with proper chatbot.",
          image: "/ml.png",
